...
header("Content-Disposition: attachment; filename=Reporte_curso.xls");
if(isset($_GET['id'])){  
    ...
    <table border="1" class="dependientes">
      ...
      <tbody>
        <tr>
          ...
          <td><?php echo $_curso['area_codigo'] ?></td>
          <td><?php echo $_curso['area_descripcion'] ?></td>
          <td><?php echo $_curso['especificacion_codigo'] ?></td>
          <td><?php echo $_curso['especificacion_descripcion'] ?></td>
          <td><?php echo $_curso['alineacion_descripcion'] ?></td>
        </tr>
      </tbody>
    </table><br>
      ...
      <tr>
        <td>
          ...
          <table border="1" class="dependientes">
            ...
            <tbody>
              <tr>
                <td colspan="2"><?php echo $_curso['tipo_participante_descripcion'] ?></td>
              </tr>
            </tbody>
          </table>
        ...
        <table border="1" class="dependientes">
          ...
          <tbody>
            <tr>
              <td colspan="2"><?php echo $_curso['modalidad_descripcion'] ?></td>
            </tr>
          </tbody>
        </table>
        ...
        <table border="1" class="dependientes">
          ...
          <tbody>
            <tr>
              <td colspan="2"><?php echo $_curso['duracion_descripcion'] ?></td>
            </tr>
          </tbody>
        </table>
...
<?php } ?>
    ...
    <table border="1" class="last_column">
        <tr>
          ...
          <td colspan="2"><?php echo $_curso['modelo_curso_hora_practica'] ?></td>
        </tr>
        <tr>
          <td colspan="2">Horas teoricas: </td>
          <td colspan="2"><?php echo $_curso['modelo_curso_hora_teorica'] ?></td>
        </tr>
<?php
